...
const FoodExchangeModal = ({ food, patientFilters, onExchange, onClose }) => {
    ...
    return (
        <Modal onClose={onClose} title="Intercambiar Alimento" className="exchange-modal">
            ...
            {loading ? (
                ...
                <div className="error-state">
                    <p>{error}</p>
                    <Button onClick={fetchEquivalents}>Reintentar</Button>
                </div>
                ...
                <div className="equivalents-list">
                    ...
                    {equivalents.map((equiv) => (
                        <div key={equiv.id} className="equivalent-card">
                            ...
                            <Button className="btn-exchange" onClick={() => handleExchange(equiv)}>
                                <ArrowRight size={16} />
                                Intercambiar
                            </Button>
                        </div>
