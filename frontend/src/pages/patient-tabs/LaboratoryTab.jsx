...
const SemaforoIcon = ({ nivel }) => {
  ...
  return <div className="w-3.5 h-3.5 rounded-full border border-[var(--border-soft)] flex-shrink-0" />;
};
    ...
    <form onSubmit={handleSave} className="space-y-8">
      ...
      {LAB_GROUPS.map(group => (
        <div key={group.grupo} className="space-y-3">
          <h3 className="section-title text-base border-b border-[var(--border-soft)] pb-2">{group.grupo}</h3>
